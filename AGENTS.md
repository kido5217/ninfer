...
Issues and specs live as GitHub issues in `kido5217/ninfer`. See `docs/agents/issue-tracker.md`.

### Triage labels

Five canonical triage labels, using the default names. See `docs/agents/triage-labels.md`.
