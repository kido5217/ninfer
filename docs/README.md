...
| [Chat-template rendering](maintainer/chat-template-rendering.md) | content vs template origin, literal spans, added-token gating, media binding and cache-prefix agreement |
